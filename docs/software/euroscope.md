...
??? question "Мне нужна помощь"
    ...
    ![Скриншот меню OTHER SET](images/installing-euroscope-next.png)
...
![Скриншот верхей панели EuroScope](euroscope/images/find-otherset.png)
...
![Скриншот меню OTHER SET](euroscope/images/otherset.png){ width="250" }
